...
const Perfil = () => {
  ...
  const videoNivelActual = nivelPendienteActual ? obtenerVideoNivel(nivelPendienteActual) : null;
            ...
            <div className="nivel-modal">
              ...
              <div className="nivel-modal-body">
                ...
                <div className="nivel-modal-text">
                  ...
                  {nivelPendienteActual.descripcion && <p>{nivelPendienteActual.descripcion}</p>}
                </div>
              </div>
              <button
                  ...
                  <div className="perfil-header">
                    ...
                    <div className="perfil-info-principal">
                      ...
                      <div className="perfil-nivel-info">
                        ...
                        <p className="nivel-actual">Nivel actual: {nivelActual?.id_nivel ?? '—'}</p>
                        <p className="nivel-descripcion">{nivelActual?.descripcion || ''}</p>
                      </div>
                    </div>
                  </div>
                      ...
                      <table className="perfil-actividades-table">
                        ...
                        <tbody>
                          {actividadesRecientes.map((mov) => {
                            ...
                            return (
                              <tr
                                key={mov.id_movimiento ?? `${mov.fecha_asistencia}-${mov.motivo}`}
                              >
